...
//
//        log.debug("[Gstdev Cloud] |- Global SQL Injection Filter in use!");
//
...
//            }
//
//            log.debug("[Gstdev Cloud] |- The original request parameter is [{}]", rawQuery);
//            // 执行XSS清理
...
//        log.error("[Gstdev Cloud] |- Parameters of Request [" + uri.getRawPath() + uri.getRawQuery() + "] contain illegal SQL keyword!");
