...
import com.gstdev.template.service.system.mapper.AccountMapper;
import com.gstdev.template.service.system.repository.AccountRepository;
...
import com.gstdev.template.service.system.repository.UserRepository;
...
public class AccountServiceImpl extends BaseServiceImpl<AccountRepository, AccountMapper, Account, AccountDto, AccountInsertInput, AccountUpdateInput, AccountPageQueryCriteria, AccountFindAllByQueryCriteria, RedisCurrentLoginInformation> implements AccountService {
  ...
  public AccountServiceImpl(AccountRepository accountRepository, AccountMapper accountMapper, RedisCurrentLoginInformation redisCurrentLoginInformation) {
    super(accountRepository, accountMapper, redisCurrentLoginInformation);
